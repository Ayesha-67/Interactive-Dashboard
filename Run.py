#TO RUN THIS CODE : streamlit run d:/OneDrive/Desktop/app.py (file path)
...
left_column.plotly_chart(fig_p_sales, use_container_width=True)
right_column.plotly_chart(fig_product_sales, use_container_width=True)

st.write("Developed by : Ayesha & Charmie")
